...
if __name__ == "__main__":
    list_1 = timeit.repeat("x = fact(130)", setup="from __main__ import fact", number=10000)
    list_2 = timeit.repeat("x = factorial(130)", setup="from __main__ import factorial", number=10000)
